...
interface ConverterDocumentoParams {
  parametro: string;
  filtro?: string;
}

async function converterDocumento(params: ConverterDocumentoParams): Promise<void> {
  try {
    ...
    console.log(`Executando converterDocumento com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Converte documento escaneado em texto concluído com sucesso",
      resultado: {
...
export default converterDocumento;
